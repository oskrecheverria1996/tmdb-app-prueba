...
export function reposCreateUsingTemplate(http: HttpClient, rootUrl: string, params: ReposCreateUsingTemplate$Params, context?: HttpContext): Observable<StrictHttpResponse<FullRepository>> {
