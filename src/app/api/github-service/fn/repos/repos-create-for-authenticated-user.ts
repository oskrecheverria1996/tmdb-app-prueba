...
export function reposCreateForAuthenticatedUser(http: HttpClient, rootUrl: string, params: ReposCreateForAuthenticatedUser$Params, context?: HttpContext): Observable<StrictHttpResponse<FullRepository>> {
