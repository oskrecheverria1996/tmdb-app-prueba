...
export function reposGetAppsWithAccessToProtectedBranch(http: HttpClient, rootUrl: string, params: ReposGetAppsWithAccessToProtectedBranch$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Integration | null>>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<Integration | null>>;
    })
  );
}
