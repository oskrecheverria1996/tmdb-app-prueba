...
export function reposAddAppAccessRestrictions(http: HttpClient, rootUrl: string, params: ReposAddAppAccessRestrictions$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Integration | null>>> {
