...
export function reposCreateInOrg(http: HttpClient, rootUrl: string, params: ReposCreateInOrg$Params, context?: HttpContext): Observable<StrictHttpResponse<FullRepository>> {
