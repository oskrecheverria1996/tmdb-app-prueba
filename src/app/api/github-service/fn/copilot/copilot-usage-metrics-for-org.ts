...
export interface CopilotUsageMetricsForOrg$Params {
...
export function copilotUsageMetricsForOrg(http: HttpClient, rootUrl: string, params: CopilotUsageMetricsForOrg$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CopilotUsageMetrics>>> {
  const rb = new RequestBuilder(rootUrl, copilotUsageMetricsForOrg.PATH, 'get');
  if (params) {
...
copilotUsageMetricsForOrg.PATH = '/orgs/{org}/copilot/usage';
