...
export class AppsService extends BaseService {
   ...
   */
  appsGetAuthenticated$Response(params?: AppsGetAuthenticated$Params, context?: HttpContext): Observable<StrictHttpResponse<Integration | null>> {
   ...
   * This method doesn't expect any request body.
   */
  appsGetAuthenticated(params?: AppsGetAuthenticated$Params, context?: HttpContext): Observable<Integration | null> {
    return this.appsGetAuthenticated$Response(params, context).pipe(
      map((r: StrictHttpResponse<Integration | null>): Integration | null => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  appsCreateFromManifest$Response(params: AppsCreateFromManifest$Params, context?: HttpContext): Observable<StrictHttpResponse<Integration | null & {
'client_id': string;
...
[key: string]: any;
   ...
   * This method doesn't expect any request body.
   */
  appsCreateFromManifest(params: AppsCreateFromManifest$Params, context?: HttpContext): Observable<Integration | null & {
'client_id': string;
'client_secret': string;
'webhook_secret': string | null;
'pem': string;
[key: string]: any;
    ...
    return this.appsCreateFromManifest$Response(params, context).pipe(
      map((r: StrictHttpResponse<Integration | null & {
'client_id': string;
'client_secret': string;
'webhook_secret': string | null;
'pem': string;
...
[key: string]: any;
   ...
   * This method doesn't expect any request body.
   */
  appsGetBySlug$Response(params: AppsGetBySlug$Params, context?: HttpContext): Observable<StrictHttpResponse<Integration | null>> {
   ...
   * This method doesn't expect any request body.
   */
  appsGetBySlug(params: AppsGetBySlug$Params, context?: HttpContext): Observable<Integration | null> {
