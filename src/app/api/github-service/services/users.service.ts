...
import { usersListAttestations } from '../fn/users/users-list-attestations';
import { UsersListAttestations$Params } from '../fn/users/users-list-attestations';
...
export class UsersService extends BaseService {
  ...
  /** Path part for operation `usersListAttestations()` */
  static readonly UsersListAttestationsPath = '/users/{username}/attestations/{subject_digest}';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `usersListAttestations()` instead.
   *
   * This method doesn't expect any request body.
   */
  usersListAttestations$Response(params: UsersListAttestations$Params, context?: HttpContext): Observable<StrictHttpResponse<{
'attestations'?: Array<{
'bundle'?: SigstoreBundle0;
'repository_id'?: number;
}>;
}>> {
    return usersListAttestations(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `usersListAttestations$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  usersListAttestations(params: UsersListAttestations$Params, context?: HttpContext): Observable<{
'attestations'?: Array<{
'bundle'?: SigstoreBundle0;
'repository_id'?: number;
}>;
}> {
    return this.usersListAttestations$Response(params, context).pipe(
