...
import { activityMarkThreadAsDone } from '../fn/activity/activity-mark-thread-as-done';
import { ActivityMarkThreadAsDone$Params } from '../fn/activity/activity-mark-thread-as-done';
...
'message'?: string;
  ...
  /** Path part for operation `activityMarkThreadAsDone()` */
  static readonly ActivityMarkThreadAsDonePath = '/notifications/threads/{thread_id}';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `activityMarkThreadAsDone()` instead.
   *
   * This method doesn't expect any request body.
   */
  activityMarkThreadAsDone$Response(params: ActivityMarkThreadAsDone$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
    return activityMarkThreadAsDone(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `activityMarkThreadAsDone$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  activityMarkThreadAsDone(params: ActivityMarkThreadAsDone$Params, context?: HttpContext): Observable<void> {
    return this.activityMarkThreadAsDone$Response(params, context).pipe(
