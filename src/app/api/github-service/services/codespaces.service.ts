...
import { codespacesCheckPermissionsForDevcontainer } from '../fn/codespaces/codespaces-check-permissions-for-devcontainer';
import { CodespacesCheckPermissionsForDevcontainer$Params } from '../fn/codespaces/codespaces-check-permissions-for-devcontainer';
...
'devcontainer_path': string | null;
  ...
  /** Path part for operation `codespacesCheckPermissionsForDevcontainer()` */
  static readonly CodespacesCheckPermissionsForDevcontainerPath = '/repos/{owner}/{repo}/codespaces/permissions_check';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `codespacesCheckPermissionsForDevcontainer()` instead.
   *
   * This method doesn't expect any request body.
   */
  codespacesCheckPermissionsForDevcontainer$Response(params: CodespacesCheckPermissionsForDevcontainer$Params, context?: HttpContext): Observable<StrictHttpResponse<CodespacesPermissionsCheckForDevcontainer>> {
    return codespacesCheckPermissionsForDevcontainer(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `codespacesCheckPermissionsForDevcontainer$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  codespacesCheckPermissionsForDevcontainer(params: CodespacesCheckPermissionsForDevcontainer$Params, context?: HttpContext): Observable<CodespacesPermissionsCheckForDevcontainer> {
    return this.codespacesCheckPermissionsForDevcontainer$Response(params, context).pipe(
      map((r: StrictHttpResponse<CodespacesPermissionsCheckForDevcontainer>): CodespacesPermissionsCheckForDevcontainer => r.body)
    );
  }
