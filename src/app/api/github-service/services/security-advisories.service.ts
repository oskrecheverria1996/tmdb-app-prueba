...
import { securityAdvisoriesCreateFork } from '../fn/security-advisories/security-advisories-create-fork';
import { SecurityAdvisoriesCreateFork$Params } from '../fn/security-advisories/security-advisories-create-fork';
...
export class SecurityAdvisoriesService extends BaseService {
  ...
  /** Path part for operation `securityAdvisoriesCreateFork()` */
  static readonly SecurityAdvisoriesCreateForkPath = '/repos/{owner}/{repo}/security-advisories/{ghsa_id}/forks';
   ...
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `securityAdvisoriesCreateFork()` instead.
   *
   * This method doesn't expect any request body.
   */
  securityAdvisoriesCreateFork$Response(params: SecurityAdvisoriesCreateFork$Params, context?: HttpContext): Observable<StrictHttpResponse<FullRepository>> {
    return securityAdvisoriesCreateFork(this.http, this.rootUrl, params, context);
  }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `securityAdvisoriesCreateFork$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  securityAdvisoriesCreateFork(params: SecurityAdvisoriesCreateFork$Params, context?: HttpContext): Observable<FullRepository> {
    return this.securityAdvisoriesCreateFork$Response(params, context).pipe(
